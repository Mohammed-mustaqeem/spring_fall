    ...
    <div className={`min-h-screen flex flex-col ${theme === 'dark' ? 'dark bg-gray-900 text-white' : ''}`}>
      ...
      <main className="flex-grow pt-28">
        ...
        <section id="f1-guide-section" className="py-16 bg-gradient-to-br from-white to-blue-50">
          <div className="container-custom mx-auto">
            <div className={`text-center mb-12 transition-all duration-700 opacity-100}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
              <div className={`transition-all duration-700 delay-200 opacity-100}`}>
              ...
              <div className={`transition-all duration-700 delay-300 opacity-100`}>
            ...
            <div className={`mt-16 text-center transition-all duration-700 delay-400 opacity-100}`}>
